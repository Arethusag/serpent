...
void Bluey_Leave_Alternate_Screen(void) {
    Bluey_Write_Standard_Output("\x1b[?1049l");
    Bluey_Flush_Standard_Output();
}

void Bluey_Hide_Cursor(void) {
    Bluey_Write_Standard_Output("\x1b[?25l");
    Bluey_Flush_Standard_Output();
}

void Bluey_Show_Cursor(void) {
    Bluey_Write_Standard_Output("\x1b[?25h");
    Bluey_Flush_Standard_Output();
}
